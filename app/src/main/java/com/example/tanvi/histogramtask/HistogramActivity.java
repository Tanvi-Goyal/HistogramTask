...
import static com.example.tanvi.histogramtask.BaseActivity.KEY_BITMAP;

public class HistogramActivity extends AppCompatActivity {

    @Bind(R.id.show_histogram_image)
    ImageView histogram_image;


    @Bind(R.id.show_original_image)
    ImageView histogram_original_image;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            path = savedInstanceState.getParcelable(KEY_BITMAP);
        } else {
            path = null;
        }
        ...
        path = bundle.getParcelable(KEY_BITMAP);
        try {
    ...
    private void drawHistogram(Bitmap bitmap) {
        try {
            ...
            BitmapHelper.showBitmap(this, bitmap, histogram_original_image);
            ...
            BitmapHelper.showBitmap(this, histBitmap, histogram_image);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
